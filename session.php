  ...
  if (isset($_GET['code'])) {
    try {
      ...
      if (mysqli_num_rows($user_check) == 0) {
        $db->query("INSERT INTO users (prime_key, name, email, permission, joined, updated, join_ip, last_ip) VALUES ('$user_id', '$name', '$email', 0, $time_now, $time_now, '$ip_hash', '$ip_hash')");
      } else {
